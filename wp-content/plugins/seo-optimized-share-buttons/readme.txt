=== Social Share Buttons - SEO Optimized ===
Contributors: spyrosli
Tags: social, social share buttons, social share, share buttons, button, buttons, share buttons, sharing, page, post, counter, social share buttons
...
Follow the new guidelines from Google with our social share buttons so you don't get punished and drop in rank! We have done all the work for you.
...
After the release of Googles new overlay update, which you can read more about on [Google's own blog](https://webmasters.googleblog.com/2016/08/helping-users-easily-access-content-on.html) Almost every share plugins are coded so they function as an overlay, where they hide parts of the screen for design and other reasons. 
...
We are also the first social share plugin to follow every single guideline and requirement from [Google Insight](https://developers.google.com/speed/docs/insights/rules) making this plugin the ultimative SEO optimized share plugin.
...
We have also altered the usual scripts provided by the social networks, we have managed to bring the load time of social share buttons down by up to 0.7 seconds! Bringing the load time down to 30% of the usual load time - And as every SEO expert know, page speed and load time is a huge part of your SEO and rankings, which you can read more about on [MOZ](https://moz.com/learn/seo/page-speed)


**Source and copyright**
_____________________________________________________________________

*   Thanks to Access Keys for creating [Social Share WordPress Plugin - AccessPress Social Share](https://wordpress.org/plugins/accesspress-social-share/) under [GPLv2](http://www.gnu.org/licenses/gpl-2.0.html)
*   Thanks to [FontAwesome](http://fontawesome.io/) which is licensed under MIT License · Documentation licensed under CC BY 3.0
...
*   We have made the design responsive and fluid so it follows [Google Insights](https://developers.google.com/speed/pagespeed/insights/) guidelines
...
Source: [Google webmaster blog](https://webmasters.googleblog.com/2016/08/helping-users-easily-access-content-on.html?m=1)
...
Source: [Quora](https://www.quora.com/What-exactly-does-lightweight-mean-when-describing-databases-or-software-frameworks)
...
1.   The user sends a request to load your page.
2.   Your server processes the request and begins loading your page.
3.   Your load encounters the script that loads the Facebook share button and begins to run the script.
4.   The script requires data from Facebook and sends a request to the Facebook servers.
5.   The Facebook servers receive the request and query their database for the relevant data.
6.   The Facebook data is received and send back to your server.
7.   Your server inputs the data in the relevant place in the script, which completes the load of that script and, presumably, the page.
8.   This is a lengthy process, and that’s just for one simple social media button. Now repeat it for Twitter if you have a Twitter button with a follower count, and repeat it for Pinterest for pins, and repeat it for Reddit for upvotes, and repeat it for every other site you have a button for.
...
Source: [Blogpros](http://blogpros.com/blog/2016/01/why-social-buttons-slow-down-your-websites-load-time)
...
Source: [Brick Marketing](http://www.brickmarketing.com/blog/social-share-buttons.htm)
...
Source: [Fastly](https://www.fastly.com/blog/caching-like-and-share-buttons)
