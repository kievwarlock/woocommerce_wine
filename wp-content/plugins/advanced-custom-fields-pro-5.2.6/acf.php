<?php
/*
Plugin Name: Advanced Custom Fields Pro (shared by jojothemes.com)
	...
	*/
	...
	function wp_init() {
		...
		$scripts = array(
			...
			array(
				'handle'	=> 'select3',
				'src'		=> acf_get_dir( "assets/inc/select2/select2.js" ),
				'deps'		=> array('jquery')
			),
			...
			array(
				...
				'deps'		=> array('jquery', 'jquery-ui-core', 'jquery-ui-sortable', 'jquery-ui-resizable', 'jquery-ui-datepicker', 'wp-color-picker', 'select3')
			),
		...
		$styles = array(
			...
			array(
				...
				'deps'		=> array('acf-global', 'wp-color-picker', 'select3', 'acf-datepicker')
			),
