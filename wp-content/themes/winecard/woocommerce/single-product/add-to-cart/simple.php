...
if ( $product->is_in_stock() ) : ?>
	...
	<form class="cart" method="post" enctype='multipart/form-data'>
		<?php
			...
			$single_add_to_cart_text =  __( 'Buy', 'woocommerce' )
		?>

		<button type="submit" name="add-to-cart" value="<?php echo esc_attr( $product->get_id() ); ?>" class="single_add_to_cart_button button alt"><?php echo esc_html( $single_add_to_cart_text ); ?></button>
